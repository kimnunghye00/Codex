...
export function MemoryDetail({ memory, onBack, onFavorite, onEdit, onDelete, onOpenPlaceTimeline, onOpenFootprints }: {
  memory: Memory;
  onBack: () => void;
  onFavorite: () => void;
  onEdit: () => void;
