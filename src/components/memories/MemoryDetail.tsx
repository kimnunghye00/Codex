...
export function MemoryDetail({ memory, onBack, onFavorite, onEdit, onDelete, onOpenPlaceTimeline }: {
  memory: Memory;
  onBack: () => void;
  onFavorite: () => void;
  onEdit: () => void;
